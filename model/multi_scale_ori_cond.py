...
class MSResNet(nn.Module):
    def __init__(self, input_channel, layers=[1, 1, 1, 1], condition_size=12):
        self.inplanes3 = 64
        self.inplanes5 = 64
        self.inplanes7 = 64
        ...
        self.idx_embed = nn.Embedding(condition_size, 32)
        ...
        self.conv_final = nn.Conv1d(768, 1, kernel_size=1, bias=False)
        self.fc = nn.Linear(111, 2)
    ...
    def forward(self, x0, idx):

        c = self.idx_embed(idx)
        x0 = torch.cat([x0, c], dim=2)
